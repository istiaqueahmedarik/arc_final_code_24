...
void get_sbus()
{
    if (sbus_rx.Read())
    {
        ...
        int vl1 = map(data.ch[12], 173, 1810, 1000, 2000);
        int vl2 = map(data.ch[7], 173, 1810, 1000, 2000);
        ...
        if (mode == 3)
        {
            ...
            if (abs(chVal[10] - 1500) <= 3)
            {
                box1(1000);
                box2(1000);
            }
            else if (abs(chVal[10] - 2000) <= 3)
            {
                box1(2000);
            }
            else if (abs(chVal[10] - 1000) <= 3)
            {
                box2(2000);
            }
        }
